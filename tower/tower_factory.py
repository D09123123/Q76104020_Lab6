...
class Tower:
    ...
    @classmethod
    def PCR(cls, x: int, y: int):                     # define pcr
        pcr = cls(x, y, Snipe(), PCR_IMAGE)           # define the function of pcr
        pcr._range = [100, 105, 110, 115, 120, 125]   # define the range of pcr
        pcr._damage = [3.0, 3.2, 3.4, 3.6, 3.8, 4.0]  # define the damage of pcr
        pcr.cd_max_count = 120                        # make the cooldown time is 120 instead of 60
        return pcr                                    # return the data of pcr 
        """
